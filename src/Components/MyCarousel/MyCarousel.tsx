            ...
            <Carousel.Item>
                ...
                <Carousel.Caption>
                    <div className="sliderText">
                        ...
                        <p>
                            WE ARE HERE TO HELP YOU WITH THE GREATEST PLAYERS OF
                            ALL TIME !!! GET SOME MONEY OUT OF THE POCKET AND
                            BUY SOMEONE SPECTACULAR !!!
                        </p>
                    </div>
                </Carousel.Caption>
            </Carousel.Item>
            ...
            <Carousel.Item>
                ...
                <Carousel.Caption>
                    <div className="sliderText">
                        ...
                        <p>
                            THOUSANDS OF FORWARDS, MIDFIELDERS, DEFENDERS AND
                            GOALKEEPERS AVAILABLE !!! NEVER GET OUT OF STOCK!!
                        </p>
                    </div>
                </Carousel.Caption>
            </Carousel.Item>
            ...
            <Carousel.Item>
                ...
                <Carousel.Caption>
                    <div className="sliderText">
                        ...
                        <p>
                            YOU NEVER NEED TO BE A RENOWNED CLUB, OUR PLAYERS
                            RESPECT EACH ONE. THEY NEVER RUN AFTER MONEY. GET
                            STARTED TODAY!!!!
                        </p>
                    </div>
                </Carousel.Caption>
